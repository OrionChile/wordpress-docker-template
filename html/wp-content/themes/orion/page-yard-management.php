...
<?php if (!post_password_required()) { ?>
	...
	<body>
		<?php get_header(); ?>
		<?php
		include('parts/traduccion.php');
		include(get_template_directory() . '/parts/pages/products/base.php');
		?>
		<?php
		include get_stylesheet_directory() . '/parts/shared/btn_contacto.php';
		get_footer(); ?>
	<?php
} else {
