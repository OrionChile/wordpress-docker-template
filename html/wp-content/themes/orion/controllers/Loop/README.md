# Loop
#### Esto reemplaza el loop query para hacerlo mas facil leer los posts

Para hacer una busqueda a un post normal


Para hacer una busqueda a un custom post filtrando por una tax
